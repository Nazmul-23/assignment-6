...
<body>
    <div class="container mt-4">
        <h2 class="text-primary mb-4">Task 1: Customer Information with Total Orders</h2>
    ...
    <div class="container mt-4">
        <h2 class="text-primary mb-4">Task 2: Product Information for Order Items</h2>
        <table class="table table-striped table-bordered">
            <thead>
                <tr class="text-center">
                    <th>Order ID</th>
    ...
    <div class="container mt-4">
        <h2 class="text-primary mb-4">Task 3: Total Revenue by Product Category</h2>
        <table class="table table-striped table-bordered">
            <thead>
                <tr class="text-center">
                    <th>Category Name</th>
    ...
    <div class="container mt-4">
        <h2 class="text-primary mb-4">Task 4: Top 5 Customers by Total Purchase Amount</h2>
        <table class="table table-striped table-bordered">
            <thead>
                <tr class="text-center">
                    <th>Customer Name</th>
